...
//obtenemos la url actual para el return del export de la newsltter
...
<body id="minwidth-body">
	...
	<div id="header-box">
        ...
        <div class="descarga_news"><a href="/administrator/templates/bluestork/descarga_newsletter.php?return=<?php echo $actual_link; ?>">Descargar Newsletter</a></div>
		<div class="clr"></div>
	</div>
