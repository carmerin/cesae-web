...
/**
 * @version 	$Id: admin.jcrawler.html.php 2011-10-15 22:39:00Z zanardi $
 * @package 	JCrawler
 * @copyright 	(C) 2011 Patrick Winkler
	...
	<table border="0" cellpadding="5" cellspacing="0" width="670">
	  ...
	  <tr>
	   ...
	   <tr>
		...
		<td width="240"><?php ( !CURL_LOADED )?print "<small><font color=\"red\"><strong>Notice: Curl is not available</strong></font></small><br />":null ?>
...
<li><input type="checkbox" name="url[]" checked="checked" value="http://www.bing.com/webmaster/ping.aspx?siteMap=<?php echo urlencode($sitemap_url) ?>" /> Bing</li>
<li><input type="checkbox" name="url[]" checked="checked" value="http://submissions.ask.com/ping?sitemap=<?php echo urlencode($sitemap_url) ?>" /> Ask.com</li>
 ...
 <?php   
	...
	{
		 print "<div align=\"center\" style=\"clear:both;\"><a href=\"index.php?option=".$option."&task=updatecheck\">Check for update</a><br />Copyright 2011 pixelschieber.ch. 
