...
if ($id=="" || $id=="0"  ):
    ...
    <div  id="slide"  >
        <a href="#" title="CESAE MDGH PDGH Cursos Redes Sociales Nebrija Instituci&oacute;n">
            ...
            <img border="0" src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-src="<?php echo $this->baseurl ?>/images/BANNER_EDAT.jpg" title="EDAT Especialista Universitario en  Direcci&oacute;n de Alojamientos Hoteleros y Tur&iacute;sticos"  alt="EDAT Especialista Universitario en  Direcci&oacute;n de Alojamientos Hoteleros y Tur&iacute;sticos " width="980px" height="250px"   onclick="JavaScript:location.href='/especialistauniversitarioenrecepciondehoteles'" style="opacity: 0.0;" />
            ...
            <img border="0" src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-src="<?php echo $this->baseurl ?>/images/BANNER_ERAT.jpg" title="ERAT Experto Universitario en  Recepci&oacute;n de Alojamientos Hoteleros y Tur&iacute;sticos"  alt="ERAT Experto Universitario en  Recepci&oacute;n de Alojamientos Hoteleros y Tur&iacute;sticos" width="980px" height="250px"   onclick="JavaScript:location.href='/expertouniversitarioenrecepciondehoteles'" style="opacity: 0.0;" />
...
<?php else:  ?>
    ...
    <div >
        ...
        elseif ($category_id=="70"  ):
            ?>
            <img id="imagentop1" src="<?php echo $this->baseurl ?>/images/BANNER_ERAT.jpg"  title="ERAT Experto Universitario en  Recepci&oacute;n de Alojamientos Hoteleros y Tur&iacute;sticos" alt="ERAT Experto Universitario en  Recepci&oacute;n de Alojamientos Hoteleros y Tur&iacute;sticos" width="980px" height="250px"  />
        <?php
...
//    die();
    ...
    <?php if ($id=="743" ):  ?>
        ...
        <div class="contenidonivel2-lateralizquierdo-salto">&nbsp;</div>
        <div class="contenidonivel2-lateralizquierdo-off"><h2 class="contenidonivel2-lateralizquierdo-boton"><a href="/curso-experto-universitario-recepcion-hoteles" title="Experto Universitario en Recepci&oacute;n de alojamientos Hoteleros y Tur&iacute;sticos (ERAT)" class="contenidonivel2-lateralizquierdo-boton" style="color:#FFFFFF;text-decoration:none !important;">Experto Universitario en Recepci&oacute;n de alojamientos Hoteleros y Tur&iacute;sticos (ERAT)</a></h2></div>
        <div class="contenidonivel2-lateralizquierdo-salto">&nbsp;</div>
