		...
		if (!isset($this->_item[$pk])) {
			...
			try {
				...
				$query->select($this->getState(
					'item.select', 'a.id, a.asset_id, a.title, a.alias, a.title_alias, a.introtext, a.fulltext, a.categoria_superior, a.imagen_mini, a.enlace_externo, a.articulo_destacado, a.subtitulo, a.infotxt1, a.infotxt2,' .
